...
course_config = CourseConfig(course_code = "delp",
                             ...
                             supported_dbrs = ["14.2.x-photon-scala2.12","13.3.x-scala2.12","11.3.x-scala2.12", "11.3.x-photon-scala2.12", "11.3.x-cpu-ml-scala2.12"],
                             expected_dbrs = "14.2.x-photon-scala2.12, 13.3.x-scala2.12, 11.3.x-scala2.12, 11.3.x-photon-scala2.12, 11.3.x-cpu-ml-scala2.12")
